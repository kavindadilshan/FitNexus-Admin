...
import { DashboardDefaultComponent } from "./pages/dashboard/dashboard-default.component";
...
import { ProfileComponent } from "./pages/profile/business-profile/profile.component";
import { BusinessProfileList } from "./pages/profile/business-profile/business-profile-list/business-profile-list";
import { CreateBusinessProfile } from "./pages/profile/business-profile/create-business-profile/create-business-profile";
import { NgxImgModule } from "ngx-img";
import { NgxTagsInputModule } from "ngx-tags-input";
import { LoginComponent } from "./pages/login/login.component";
import { BrowserModule } from "@angular/platform-browser";
import { UpdateBusinessProfileService } from "./pages/profile/business-profile/update-business-profile/update-business-profile-service";
import { UpdateBusinessProfile } from "./pages/profile/business-profile/update-business-profile/update-business-profile";
import { Ng2SearchPipeModule } from "ng2-search-filter";
import { NgProgressHttpModule } from "@ngx-progressbar/http";
import { CoachProfileComponent } from "./pages/profile/coach-profile/coach-profile.component";
import { CoachProfileList } from "./pages/profile/coach-profile/coach-profile-list/coach-profile-list";
import { CreateCoachProfile } from "./pages/profile/coach-profile/create-coach-profile/create-coach-profile";
import { UpdateCoachProfileService } from "./pages/profile/coach-profile/update-coach-profile/update-coach-profile-service";
import { UpdateCoachProfile } from "./pages/profile/coach-profile/update-coach-profile/update-coach-profile";
import { PackageTypeComponent } from "./pages/package/package-type/package-type.component";
import { PackageTypeList } from "./pages/package/package-type/package-type-list/package-type-list";
import { PackageComponent } from "./pages/package/package.component";
import { PackageList } from "./pages/package/package-list/package-list";
import { ClassesList } from "./pages/classes/classes-list/classes-list";
import { ClassesComponent } from "./pages/classes/classes.component";
import { SessionComponent } from "./pages/classes/session/session.component";
import { SessionList } from "./pages/classes/session/session-list/session-list";
import { PublicUserProfileComponent } from "./pages/profile/public-user-profile/public-user-profile.component";
import { PublicUserProfileReport } from "./pages/profile/public-user-profile/public-user-profile-report/public-user-profile-report";
import { ClassTypeComponent } from "./pages/classes/class-type/class-type.component";
import { ClassTypeList } from "./pages/classes/class-type/class-type-list/class-type-list";
import { CreateClass } from "./pages/classes/create-classes/create-class";
import { CreateSessionService } from "./pages/classes/session/create-session/create-session-service";
import { CreateSession } from "./pages/classes/session/create-session/create-session";
import { UpdateClassService } from "./pages/classes/update-class/update-class-service";
import { UpdateClass } from "./pages/classes/update-class/update-class";
import { StarRatingModule } from "angular-star-rating";
import { UpdateSession } from "./pages/classes/session/update-session/update-session";
import { UpdateSessionService } from "./pages/classes/session/update-session/update-session-service";
import { ChangePassword } from "./pages/change-password/change-password";
import { NgxIntlTelInputModule } from "ngx-intl-tel-input";
import { OnlinePersonalClasses } from "./pages/classes/online-personal-classes/online-personal-classes";
import { CreateOnlinePersonalClass } from "./pages/classes/create-online-personal-class/create-online-personal-class";
import { UpdateOnlinePersonalClass } from "./pages/classes/update-online-personal-class/update-online-personal-class";
import { CreateGroupClassSession } from "./pages/classes/session/create-group-class-session/create-group-class-session";
import { UpdateGroupClassSession } from "./pages/classes/session/update-group-class-session/update-group-class-session";
import { PersonalClassSessionList } from "./pages/classes/session/persoanl-class-session-list/personal-class-session-list";
import { CreatePersonalSession } from "./pages/classes/session/create-personal-session/create-personal-session";
import { NewPersonalClassSession } from "./pages/classes/session/new-personal-session/new-personal-class-session";
import { UpdatePersonalClassSession } from "./pages/classes/session/update-personal-session/update-personal-class-session";
import { UpdateProfileMangerPasswordComponent } from "./pages/update-profile-manager-password/update-profile-manger-password.component";
import { AssignCoach } from "./pages/profile/coach-profile/assign-coach/assign-coach";
import { FinancialsComponent } from "./pages/financials/financials.component";
import { FinancialList } from "./pages/financials/financialsList/financialList";
import { ViewLocation } from "./pages/profile/business-profile/view-location/view-location";
import { SubscriptionRevenue } from "./pages/financials/subscription-revenue/subscription-revenue";
import { DuePayments } from "./pages/financials/due-payments/due-payments";
import { LanguagesComponent } from "./pages/languages/languages.component";
import { StudioPaymentSummery } from "./pages/financials/studio-payment-summery/studio-payment-summery";
import { PhysicalClassesList } from "./pages/classes/physical-classes/physical-classes-list/physical-classes-list";
import { physicalClassesComponent } from "./pages/classes/physical-classes/physical-classes.component";
import { CreatePhysicalClass } from "./pages/classes/physical-classes/create-physical-class/create-physical-class";
import { UpdatePhysicalClass } from "./pages/classes/physical-classes/update-physical-class/update-physical-class";
import { UpdatePhysicalClassService } from "./pages/classes/physical-classes/update-physical-class/update-physical-class-service";
import { CreatePhysicalSession } from "./pages/classes/session/create-physical-session/create-physical-session";
import { gymComponent } from "./pages/gym/gym.component";
import { GymList } from "./pages/gym/gym-list/gym-list";
import { CreateGym } from "./pages/gym/create-gym/create-gym";
import { CoreModule } from "./core/core.module";
import { PhysicalClassSessionList } from "./pages/classes/session/physical-class-session-list/physical-class-session-list";
import { NewPhysicalClassSession } from "./pages/classes/session/new-physical-class-session/new-physical-class-session";
import { CreatePhysicalSessionService } from "./pages/classes/session/create-physical-session/create-physical-session-service";
import { UpdatePhysicalClassSession } from "./pages/classes/session/update-physical-class-session/update-physical-class-session";
import { UpdatePhysicalClassSessionService } from "./pages/classes/session/update-physical-class-session/update-physical-class-session-service";
import { UpdateGymService } from "./pages/gym/update-gym/update-gym-service";
import { UpdateGym } from "./pages/gym/update-gym/update-gym";
import { ClassesMembershipList } from "./pages/membership/classes-membership/classes-membership-list/classes-membership-list";
import { ClassMembershipComponent } from "./pages/membership/classes-membership/class-membership-component";
import { MembershipList } from "./pages/membership/classes-membership/membership-list/membership-list";
import { CreateMembership } from "./pages/membership/classes-membership/create-membership/create-membership";
import { NewMembership } from "./pages/membership/classes-membership/new-membership/new-membership";
import { UpdateMembership } from "./pages/membership/classes-membership/update-membership/update-membership";
import { UpdateMembershipService } from "./pages/membership/classes-membership/update-membership/update-membership-service";
import { ClassStatus } from "./pages/class-status/class-status";
import { GymMembershipComponent } from "./pages/membership/gym-membership/gym-membership-component";
import { GymMembershipList } from "./pages/membership/gym-membership/gym-membership-list/gym-membership-list";
import { CreateGymMembership } from "./pages/membership/gym-membership/create-gym-membership/create-gym-membership";
import { UpdateGymMembership } from "./pages/membership/gym-membership/update-gym-membership/update-gym-membership";
import { UpdateGymMembershipService } from "./pages/membership/gym-membership/update-gym-membership/update-gym-membership-service";
import { AdvertisementComponent } from "./pages/advertisement/advertisement.component";
import { AdvertisementList } from "./pages/advertisement/advertisement-list/advertisement-list";
import { CoachingTypesComponent } from "./pages/coaching-types/coaching-types.component";
import { CoachingTypeList } from "./pages/coaching-types/coaching-type-list/coaching-type-list";
import { NotificationComponent } from "./pages/notification/notification.component";
import { NotificationList } from "./pages/notification/notification-list/notification-list";
import { NgZorroAntdModule, NZ_I18N, en_US } from "ng-zorro-antd";
import { AllSessions } from "./pages/classes/session/all-sessions/all-sessions";
import { OnlineClassesMembershipComponent } from "./pages/membership/online-classes-membership/online-classes-membership-component";
import { OnlineClassesMembershipList } from "./pages/membership/online-classes-membership/online-classes-membership-list/online-classes-membership-list";
import { CreateOnlineClassesMembership } from "./pages/membership/online-classes-membership/create-online-membership/create-online-classes-membership";
import { OnlineClassPackageList } from "./pages/membership/online-classes-membership/online-class-package-list/online-class-package-list";
import { NewOnlineClassPackage } from "./pages/membership/online-classes-membership/new-online-class-package/new-online-class-package";
import { UpdateOnlineClassMembership } from "./pages/membership/online-classes-membership/update-online-class-membership/update-online-class-membership";
import { UpdateOnlineClassMembershipService } from "./pages/membership/online-classes-membership/update-online-class-membership/update-online-class-membership-service";
import { CorporateComponent } from "./pages/corporates/corporate.component";
import { CorporateList } from "./pages/corporates/corporate-list/corporate-list";
import { CreateCorporate } from "./pages/corporates/create-corporate/create-corporate";
import { EditCorporate } from "./pages/corporates/edit-corporate/edit-corporate";
import { EditCorporateService } from "./pages/corporates/edit-corporate/edit-corporate-service";
import { CorporateMembershipComponent } from "./pages/membership/corporate-membership/corporate-membership-component";
import { CorporateMembershipList } from "./pages/membership/corporate-membership/corporate-membership-list/corporate-membership-list";
import { CreateCorporateMembership } from "./pages/membership/corporate-membership/create-corporate-membership/create-corporate-membership";
import { NgxCsvParserModule } from "ngx-csv-parser";
import { UpdateCorporateMembershipService } from "./pages/membership/corporate-membership/update-corporate-membership/update-corporate-membership-service";
import { UpdateCorporateMembership } from "./pages/membership/corporate-membership/update-corporate-membership/update-corporate-membership";
import { TimeTable } from "./pages/time-table/time-table";
import { WeekTimetable } from "./pages/timetable/week-timetable";
import { PromocodeComponent } from "./pages/promo_code/promocode.component";
import { Promo_code_list } from "./pages/promo_code/promo_code_list/promo_code_list";
import { CreatePromoCode } from "./pages/promo_code/create-promo-code/create-promo-code";
import { SubscriptionPackageComponent } from "./pages/membership/subscription-package/subscription-package-component";
import { SubscriptionPackageList } from "./pages/membership/subscription-package/subscription-package-list/subscription-package-list";
import {CreateSubscriptionPackage} from "./pages/membership/subscription-package/create-subscription-package/create-subscription-package";
import {UpdateSubscriptionPackage} from "./pages/membership/subscription-package/update-subscription-package/update-subscription-package";
import {UpdateSubscriptionPackageService} from "./pages/membership/subscription-package/update-subscription-package/update-subscription-package-service";
import {MonthlySubscriptions} from "./pages/financials/monthly-subscriptions/monthlySubscriptions";
import {MembershipActivationHistory} from "./pages/reports/membership-activation-history/membership-activation-history";
import {AttendanceReport} from "./pages/reports/attendance-report/attendance-report";
...
@NgModule({
  declarations: [
    ...
    UpdateSession,
    ChangePassword,
    OnlinePersonalClasses,
    CreateOnlinePersonalClass,
    UpdateOnlinePersonalClass,
    CreateGroupClassSession,
    UpdateGroupClassSession,
    PersonalClassSessionList,
    CreatePersonalSession,
    NewPersonalClassSession,
    UpdatePersonalClassSession,
    UpdateProfileMangerPasswordComponent,
    AssignCoach,
    FinancialsComponent,
    FinancialList,
    ViewLocation,
    SubscriptionRevenue,
    DuePayments,
    StudioPaymentSummery,
    LanguagesComponent,
    PhysicalClassesList,
    physicalClassesComponent,
    CreatePhysicalClass,
    UpdatePhysicalClass,
    ...
    GymList,
    CreateGym,
    PhysicalClassSessionList,
    NewPhysicalClassSession,
    UpdatePhysicalClassSession,
    UpdateGym,
    ClassMembershipComponent,
    ClassesMembershipList,
    MembershipList,
    CreateMembership,
    NewMembership,
    UpdateMembership,
    ...
    AdvertisementList,
    CoachingTypesComponent,
    CoachingTypeList,
    NotificationComponent,
    NotificationList,
    AllSessions,
    OnlineClassesMembershipComponent,
    OnlineClassesMembershipList,
    CreateOnlineClassesMembership,
    OnlineClassPackageList,
    NewOnlineClassPackage,
    UpdateOnlineClassMembership,
    CorporateComponent,
    CorporateList,
    CreateCorporate,
    EditCorporate,
    CorporateMembershipComponent,
    CorporateMembershipList,
  ...
  imports: [
    ...
    AgmCoreModule.forRoot({
      apiKey: "AIzaSyBKgnKVPFNroX1gn7QqTR-MC17tuHPUWpQ",
  ...
  providers: [
    ...
    UpdateClassService,
    UpdatePhysicalClassService,
    UpdateSessionService,
    CreatePhysicalSessionService,
    UpdatePhysicalClassSessionService,
    UpdateGymService,
    UpdateMembershipService,
    UpdateOnlineClassMembershipService,
    UpdateGymMembershipService,
    EditCorporateService,
    UpdateCorporateMembershipService,
    UpdateSubscriptionPackageService,
    {
